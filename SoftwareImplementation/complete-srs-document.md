...
| BKG-04 | ระบบต้องรองรับการจองห้องพัก:<br>- เลือกวันเช็คอิน-เช็คเอาท์<br>- เลือกจำนวนและประเภทห้อง<br>- ระบุจำนวนผู้เข้าพัก<br>- เลือกแพ็คเกจเสริม<br>- เพิ่มฟังก์ชันการแก้ไขและการจอง<br>- ใส่โค้ดส่วนลด | High |
| BKG-05 | ระบบต้องส่งอีเมลยืนยันการจองทันทีหลังจองสำเร็จ<br>- ลูกค้าสามารเข้าไปเปลี่ยนวันเวลาในการจองได้เสมอ<br> | High |
...
| ADM-03 | ระบบต้องสามารถออกรายงานต่างๆ<br>- รายงานสถิติการเข้าพัก<br>- รายงานห้องพักว่าง-ไม่ว่าง<br>- รายงานการจองและยกเลิก   | Medium |
...
| PRF-03 | เวลาประมวลผลการชำระเงิน | ≤ 3 วินาที |
...
| USB-03 | รองรับภาษาไทยและอังกฤษ- เพิ่มปุ่มที่สามารถเปลี่ยนภาษาได้ตามที่ต้องการ | High |
...
| REL-03 | ระยะเวลาในการกู้คืนระบบ | ≤ 1 ชั่วโมง |
